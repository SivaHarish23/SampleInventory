...
public class ProductDAO {
    ...
    public boolean insert(Product product) throws SQLException {
        String sql = "INSERT INTO products (name, cost_price, selling_price, opening_stock) VALUES (?, ?, ?, ?)";
    ...
    public List<Product> getAllRows() throws SQLException {
        ...
        try (Connection connection = DBConnection.getInstance().getConnection()) {
            ...
            while (resultSet.next()) {
                allProducts.add(new Product.Builder().id(resultSet.getInt("id")).name(resultSet.getString("name")).cost_price(resultSet.getBigDecimal("cost_price")).selling_price(resultSet.getBigDecimal("selling_price")).opening_stock(resultSet.getInt("opening_stock")).build());
            }
        }
        return allProducts;
    }
    ...
    public Product findProduct(int id) throws SQLException {
        ...
        try (Connection conn = DBConnection.getInstance().getConnection()) {
            ...
            return new Product.Builder().id(resultSet.getInt("id")).name(resultSet.getString("name")).cost_price(resultSet.getBigDecimal("cost_price")).selling_price(resultSet.getBigDecimal("selling_price")).opening_stock(resultSet.getInt("opening_stock")).build();
        }
    }
